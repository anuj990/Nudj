...
fun MyClubScreenPreview() {
    val previewClubs = listOf(
        ClubUser(
            ...
            achievements = "Published anthology of student poems, Hosted literary fest",
        ...
        ClubUser(
            ...
            achievements = "HackByte, Central India's largest hackathon",
        ...
        ClubUser(
            ...
            achievements = "University Champions 2023, Quarter-finalists in State Championship",
        ...
        ClubUser(
            ...
            achievements = "Winners of State Dance Championship, Performed at 5 college festivals",
